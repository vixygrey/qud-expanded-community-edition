...
namespace XRL.World.Effects
{
    ...
    public class Vixy_Burdened : IScribedEffect
    {
        ...
        /// <summary>
        /// Writes and reads nothing, symmetrically, so this effect occupies no bytes in a save.
        /// </summary>
        /// <remarks>
        /// <para>
        /// <c>IScribedEffect</c> does exactly one thing in each direction — <c>WriteNamedFields</c> and
