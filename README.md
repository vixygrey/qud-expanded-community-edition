...
Twenty options, in Qud's own options menu under **Mods**. If you want the weapons and armor but not
...
document is also the complete reference for the mod itself: every system, all 466 new blueprints and
211 vanilla merges.
